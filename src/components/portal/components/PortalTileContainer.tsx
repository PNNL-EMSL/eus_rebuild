...
export default class PortalTileContainer extends TileContainer {
  ...
  tileData = [{id: 0, size:"x-large", visibleBy:1, text: 'Publications', img: "far fa-file-alt fa-3x", path: '/Portal/publications'},
    ...
    {id: 1, size:"small", visibleBy:1, text: 'Training', img: "far fa-list-alt fa-3x", path: '/Portal/training'},
    {id: 3, size:"small", visibleBy:10, text: 'Schedule Experiments', img: "far fa-calendar-alt fa-3x", path: '/Portal/scheduleExperiments'},
    {id: 4, size:"small", visibleBy:1, text: 'User Information', img: "fas fa-user-tie fa-3x", path: '/Portal/userInfo'},
  ];
